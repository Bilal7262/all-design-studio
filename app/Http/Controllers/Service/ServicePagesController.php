...
class ServicePagesController extends Controller
{
    ...
    public function showPage(Request $request){
        $page = ServicePage::with('snippet','images','banner','feature','feature_clone','orders','orders_clone','sample','pricing','testimonial','faq','seo','cta','interlinking')->where('id', $request->id)->first();
        return response()->json([
            'status' => 200,
            'message' => 'Successfully fetched',
            'page' => $page
